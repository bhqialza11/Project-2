...
<html lang="en" class="scroll-smooth">
  <head>
    ...
    <link
      ...
      type="image/x-icon"
    />
    <link rel="stylesheet" href="<?php echo base_url();?>landing_page/assets/css/animate.css" />
    <link rel="stylesheet" href="<?php echo base_url();?>landing_page/assets/css/tailwind.css" />

    <!-- ==== WOW JS ==== -->
    <script src="<?php echo base_url();?>landing_page/assets/js/wow.min.js"></script>
    <script>
      new WOW().init();
    </script>
  </head>
        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4">
            <div class="mb-12 max-w-[620px] lg:mb-20">
              ...
              >
                Keunggulan Aplikasi Rental Mobil Sejahtera
              </h2>
              <p
        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".1s">
              ...
              <p class="mb-8 text-body-color lg:mb-11">
                Harga yang disesuaikan dengan rekening pengguna
              </p>
              <!-- <a
                href="javascript:void(0)"
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".2s">
              ...
              <p class="mb-8 text-body-color lg:mb-11">
               Memudahkan pengguna untuk menyewa mobil
              </p>
              <!-- <a
                href="javascript:void(0)"
                class="text-base font-medium text-body-color hover:text-primary"
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            ...
            >
              ...
              <p class="mb-8 text-body-color lg:mb-11">
              Pengguna tidak perlu ribet-ribet untuk menyewa mobil
              </p>
              <!-- <a
                href="javascript:void(0)"
                class="text-base font-medium text-body-color hover:text-primary"
            ...
            >
              ...
              <div class="ud-testimonial-info flex items-center">
                ...
                <div class="ud-testimonial-meta">
                  ...
                  <p class="text-xs text-[#969696]">Founder @Rentalmobilsejahtera</p>
                </div> -->
              </div>
            </div>
          </div>
